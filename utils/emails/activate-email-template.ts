                          ...
                          <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                            ...
                            <tr>
                              <td align="center" style="padding:0;Margin:0;font-size:0px"><a target="_blank"
                                ...
                                class="adapt-img"
                                src="https://dzhwaj.stripocdn.email/content/guids/CABINET_0016b835f0a5fba998176a54137bac52e2f5c3435dbfdf33f9cb5ea1c0df8b64/images/logo.png"
                                alt
                          ...
                          <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                            ...
                            <tr>
                              <td align="center" style="padding:0;Margin:0;font-size:0px"><img
                                src="https://dzhwaj.stripocdn.email/content/guids/CABINET_2663efe83689b9bda1312f85374f56d2/images/10381620386430630.png"
                                alt
                                style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                width="100"></td>
                            </tr>
                            ...
                            <tr>
                              <td align="center" class="es-m-p0r"
                                  style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;padding-right:40px"><p
                                ...
                                Thank you for choosing PayShop.</p>
                                <p
                                  style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:24px;color:#333333;font-size:16px">
                                  <br></p>
                                <p
                                  style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:24px;color:#333333;font-size:16px">
                                  Please confirm that <strong><a target="_blank" href="mailto:${to}"
                                                                 style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#134F5C;font-size:16px"></a>${to}</strong>&nbsp;is
                                  your email address by clicking on the button below or use this link <a target="_blank"
                                                                                                         href=${url}
                                                                                                         style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#134F5C;font-size:16px;word-break:break-all">${url}</a>
                                  within <strong>48 hours</strong>.</p></td>
                            </tr>
                            <tr>
                              <td align="center" class="es-m-txt-c"
                                  style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0">
                            ...
                            <tr>
                              <td align="center" class="es-m-txt-l"
                                  style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><!--[if mso]><a
                                href="${url}" target="_blank" hidden>
                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                             xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton
                                             href="${url}"
                                             style="height:39px; v-text-anchor:middle; width:186px" arcsize="0%"
                                             strokecolor="#999999" strokeweight="1px" fillcolor="#ffffff">
                                  <w:anchorlock></w:anchorlock>
                                  <center
                                    style="color:#666666; font-family:Montserrat, sans-serif; font-size:14px; font-weight:400; line-height:14px; mso-text-raise:1px">
                                    Verify my email
                                  </center>
                                </v:roundrect>
                              </a>
